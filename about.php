        ...
        <div class="container-wrapper">
            ...
            <div id="container">
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-outher">
                        <div class="page-title-inner">
                            ...
                            <h1 class="page-title">Sobre nosaltres</h1>
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="page-wrapper">
                    <h1>Pizza Nyam.<br /> Qui Som?</h1>
                    <p>Pizza Nyam es una pizzeria amb molta historia a la ciutat de Berga ...</p>
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <p><img class="aligncenter size-full wp-image-63" src="images/masa.jpg" alt="" width="415" height="366" /></p>
                    ...
                    <p>&nbsp;</p>
                    <p><img class="aligncenter size-full wp-image-65" src="images/team.jpg" alt="" width="431" height="532" /></p>
                    <div class="clear"></div>
                </div>
