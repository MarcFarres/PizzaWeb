...
<div id="header" class="header-wrapper">
            <div class="logo">
                <a href="index.php" title="PIZZA NYAM">
                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            ...
                            <li class="menu-item <?php echo ($selected == 'contacte' ? $selected_styles : ''); ?>"><a href="contacte.php">Contacte</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu-1" class="mobile-menu">
                    <li class="menu-item <?php echo ($selected == 'home' ? $selected_styles : ''); ?>"><a href="index.php">Home</a></li>
                    <li class="menu-item <?php echo ($selected == 'menu' ? $selected_styles : ''); ?>"><a href="menu.php">Menu</a></li>
                    <li class="menu-item <?php echo ($selected == 'pizzes' ? $selected_styles : ''); ?>"><a href="pizzas.php">Pizzas</a></li>
                    <li class="menu-item <?php echo ($selected == 'about' ? $selected_styles : ''); ?>"><a href="about.php">Qui som</a></li>
                    <li class="menu-item <?php echo ($selected == 'contacte' ? $selected_styles : ''); ?>"><a href="contacte.php">Contact</a></li>
